...
export const MenubarTrigger = <T extends ValidComponent = 'button'>(
  ...
  const [local, rest] = splitProps(props as menubarTriggerProps, [
    'class',
  ]);
...
type menubarSubTriggerProps<T extends ValidComponent = 'button'> =
  ParentProps<
...
export const MenubarSeparator = <T extends ValidComponent = 'hr'>(
  ...
  const [local, rest] = splitProps(props as menubarSeparatorProps, [
    'class',
  ]);
